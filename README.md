...
[![GoDoc](https://pkg.go.dev/badge/github.com/desperatee/solana-go?status.svg)](https://pkg.go.dev/github.com/desperatee/solana-go@v1.5.0?tab=doc)
[![GitHub tag (latest SemVer pre-release)](https://img.shields.io/github/v/tag/gagliardetto/solana-go?include_prereleases&label=release-tag)](https://github.com/desperatee/solana-go/releases)
[![Build Status](https://github.com/desperatee/solana-go/workflows/tests/badge.svg?branch=main)](https://github.com/desperatee/solana-go/actions?query=branch%3Amain)
[![TODOs](https://badgen.net/https/api.tickgit.com/badgen/github.com/desperatee/solana-go/main)](https://www.tickgit.com/browse?repo=github.com/desperatee/solana-go&branch=main)
[![Go Report Card](https://goreportcard.com/badge/github.com/desperatee/solana-go)](https://goreportcard.com/report/github.com/desperatee/solana-go)
...
**If you're looking for a SERUM library, you can check out [gagliardetto/serum-go](https://github.com/gagliardetto/serum-go) ([./programs/serum](https://github.com/desperatee/solana-go/tree/main/programs/serum) is deprecated.**)
...
```bash
$ cd my-project
$ go get github.com/desperatee/solana-go@v1.5.0
```
...
You can wait for a transaction confirmation using the `github.com/desperatee/solana-go/rpc/sendAndConfirmTransaction` package tools (for a complete example: [see here](#transfer-sol-from-one-wallet-to-another-wallet))
...
import (
  ...
  "github.com/desperatee/solana-go/programs/system"
  "github.com/desperatee/solana-go/rpc"
  confirm "github.com/desperatee/solana-go/rpc/sendAndConfirmTransaction"
  "github.com/desperatee/solana-go/rpc/jsonrpc"
